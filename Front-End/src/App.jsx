        ...
        <>
            <Router>
                ...
                <Routes>
                    ...
                    <Route path="/vehicle/:vehicleId" element={<SingleVehiclePage />} /> {/* Added Single Vehicle Route */}
                    ...
                    {/* QR Code Routes */}
                    <Route path="/qr/:vehicleId" element={<QRCodePage />} /> {/* Added QR Code page for specific vehicle */}
