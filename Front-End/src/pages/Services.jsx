       ...
       <> 
         ...
         <div className="container mx-auto p-6">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             {/* Service 1 */}
             <div className="shadow-lg p-8 rounded-2xl border border-green-200 bg-green-50 transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl min-h-[300px] flex flex-col justify-between">
               <div className="flex flex-col items-center text-center">
                 ...
                 <p className="text-black mt-8 text-center leading-relaxed">
             ...
             <div className="shadow-lg p-8 rounded-2xl border border-green-200 bg-green-50 transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl min-h-[300px] flex flex-col justify-between">
               <div className="flex flex-col items-center text-center">
                 ...
                 <p className="text-black mt-6 text-center leading-relaxed">
